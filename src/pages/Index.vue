<template>
  <q-page class="bg-light absolute-top">
    <div class="row justify-between main">
        ...
        >
          <div>
            ...
            <!-- Main section button-->
            <q-btn class="main-btn" color="accent" label="Go to the Map" v-on:click="map" />
          </div>
        </q-parallax>
